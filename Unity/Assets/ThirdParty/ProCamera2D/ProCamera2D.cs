...
namespace Com.LuisPedroFonseca.ProCamera2D
{
    ...
    public class ProCamera2D : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        {
            _transform.localPosition = VectorHVD(cameraPos.x, cameraPos.y, cameraPos.z);
        ...
        public void Move(float deltaTime)
        {
            ...
            var deltaMovement = _cameraTargetPosition - _transform.localPosition;
            if (_needSmooth)
            {
                ...
                deltaMovement = VectorHV(horizontalDeltaMovement, verticalDeltaMovement);
            }
